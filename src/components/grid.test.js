...
describe('Creation of a Grid Object with negative inputs', () => {
    ...
    test('check to see if grid of [5,5] created from (-20,-20)', () => {
        expect(grid.dimensions()).toEqual(alternateGrid);
    })
...
describe('Creation of a Grid Object with alpha inputs', () => {
    ...
    const alternateGrid = { 'x':5, 'y':5};
    test('check to see if grid of [5,5] created from ("a", "b")', () => {
        expect(grid.dimensions()).toEqual(alternateGrid);
    })
...
describe('Creation of a Grid Object with symbol inputs', () => {
    const grid = new Grid('#','$');
    const alternateGrid = { 'x':5, 'y':5};
    test('check to see if grid of [5,5] created ("#","$")', () => {
        expect(grid.dimensions()).toEqual(alternateGrid);
    })
...
describe('Creation of a Grid Object with Huge size', () => {
    ...
    test('check to see if grid of [1000,1000] created from (1000,1000)', () => {
        expect(grid.dimensions()).toEqual(alternateGrid);
    })

    test('check to see output of size = [1000,1000]', () => {
        expect(grid.sizeStr()).toContain("[1000,1000]")
    })
})
...
describe('Creation of a Grid Object with negative/positive values', () => {
    ...
    const alternateGrid = { 'x':5, 'y':5};
    test('check to see if grid of [5,5] created from (-1,5)', () => {
        expect(grid.dimensions()).toEqual(alternateGrid);
    })
...
describe('Creation of a Grid Object with positive/negative values', () => {
    ...
    test('check to see if grid of [10,5] created from (10,-5)', () => {
        expect(grid.dimensions()).toEqual(alternateGrid);
    })

    test('check to see output of size = [10,5]', () => {
        expect(grid.sizeStr()).toContain("[10,5]")
    })
})